...
--
-- Name: hpk_articletag; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.hpk_articletag (
    id bigint NOT NULL,
...
ALTER TABLE public.hpk_articletag OWNER TO wagtail;

--
-- Name: hpk_articletag_id_seq; Type: SEQUENCE; Schema: public; Owner: wagtail
--

ALTER TABLE public.hpk_articletag ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: hpk_articletagrelation; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.hpk_articletagrelation (
    id bigint NOT NULL,
...
ALTER TABLE public.hpk_articletagrelation OWNER TO wagtail;

--
-- Name: hpk_articletagrelation_id_seq; Type: SEQUENCE; Schema: public; Owner: wagtail
--

ALTER TABLE public.hpk_articletagrelation ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: hpk_articletag hpk_articletag_name_key; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.hpk_articletag
    ADD CONSTRAINT hpk_articletag_name_key UNIQUE (name);


--
-- Name: hpk_articletag hpk_articletag_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--
...
--
-- Name: hpk_articletag hpk_articletag_slug_key; Type: CONSTRAINT; Schema: public; Owner: wagtail
--
...
--
-- Name: hpk_articletagrelation hpk_articletagrelation_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.hpk_articletagrelation
...
CREATE INDEX hpk_articletag_name_1fdd19d7_like ON public.hpk_articletag USING btree (name varchar_pattern_ops);
...
CREATE INDEX hpk_articletag_slug_3691df80_like ON public.hpk_articletag USING btree (slug varchar_pattern_ops);
...
CREATE INDEX hpk_articletagrelation_content_object_id_36fef17a ON public.hpk_articletagrelation USING btree (content_object_id);
...
CREATE INDEX hpk_articletagrelation_tag_id_79e06179 ON public.hpk_articletagrelation USING btree (tag_id);
...
--
-- Name: hpk_articletagrelation hpk_articletagrelati_content_object_id_36fef17a_fk_hpk_artic; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--
...
--
-- Name: hpk_articletagrelation hpk_articletagrelation_tag_id_79e06179_fk_hpk_articletag_id; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.hpk_articletagrelation
    ADD CONSTRAINT hpk_articletagrelation_tag_id_79e06179_fk_hpk_articletag_id FOREIGN KEY (tag_id) REFERENCES public.hpk_articletag(id) DEFERRABLE INITIALLY DEFERRED;
