...
--
-- Name: hpk_articletagitem; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.hpk_articletagitem (
    id bigint NOT NULL,
...
ALTER TABLE public.hpk_articletagitem OWNER TO wagtail;

--
-- Name: hpk_articletagitem_id_seq; Type: SEQUENCE; Schema: public; Owner: wagtail
--

ALTER TABLE public.hpk_articletagitem ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.hpk_articletagitem_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: hpk_articletagitem hpk_articletagitem_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.hpk_articletagitem
    ADD CONSTRAINT hpk_articletagitem_pkey PRIMARY KEY (id);
...
--
-- Name: hpk_articletagitem_content_object_id_e5e52a34; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX hpk_articletagitem_content_object_id_e5e52a34 ON public.hpk_articletagitem USING btree (content_object_id);


--
-- Name: hpk_articletagitem_tag_id_8e85bdc7; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX hpk_articletagitem_tag_id_8e85bdc7 ON public.hpk_articletagitem USING btree (tag_id);
...
--
-- Name: hpk_articletagitem hpk_articletagitem_content_object_id_e5e52a34_fk_hpk_artic; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.hpk_articletagitem
    ADD CONSTRAINT hpk_articletagitem_content_object_id_e5e52a34_fk_hpk_artic FOREIGN KEY (content_object_id) REFERENCES public.hpk_article(page_ptr_id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: hpk_articletagitem hpk_articletagitem_tag_id_8e85bdc7_fk_taggit_tag_id; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.hpk_articletagitem
    ADD CONSTRAINT hpk_articletagitem_tag_id_8e85bdc7_fk_taggit_tag_id FOREIGN KEY (tag_id) REFERENCES public.taggit_tag(id) DEFERRABLE INITIALLY DEFERRED;
